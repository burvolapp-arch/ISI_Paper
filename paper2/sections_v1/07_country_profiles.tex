...
\begin{itemize}[leftmargin=2em]
  ...
  \item \textbf{Upper-middle}: Ireland (rank~3), Netherlands (rank~15).
  \item \textbf{Lower ranks}: Germany (rank~22), Slovakia (rank~26),
    Finland (rank~6), France (rank~27).
  \item \textbf{Diverse axis profiles}: Ireland (technology-peaked),
    Netherlands (defence-peaked), Finland (logistics-peaked), Slovakia
    (zero-defence outlier).
\end{itemize}
...
\begin{enumerate}[leftmargin=2em]
  \item \textbf{Small-island concentration} (Malta, Cyprus): high
    across defence and logistics, moderate elsewhere.
  \item \textbf{Sector-specific spike} (Ireland: technology;
    Netherlands: defence): one axis sharply elevated, others
    dispersed.
  \item \textbf{Broad diversification} (Germany, France): all axes
    near or below the EU-27 mean, reflecting large-economy effects.
\end{enumerate}
