% F12_radar_DE: Radar chart for Germany (DE)
% Values: Fin=0.102, Ene=0.329, Tec=0.098, Def=0.583, Cri=0.223, Log=0.273
\begin{tikzpicture}[scale=1.0]
  ...
  % Data polygon: DE
  \filldraw[orange!20, draw=orange!70, thick, fill opacity=0.3]
    ( 90:0.102*3cm) -- ( 30:0.329*3cm) -- (330:0.098*3cm) --
    (270:0.583*3cm) -- (210:0.223*3cm) -- (150:0.273*3cm) -- cycle;
  % Data points
  \fill[orange!70] ( 90:0.102*3cm) circle (2pt);
  \fill[orange!70] ( 30:0.329*3cm) circle (2pt);
  \fill[orange!70] (330:0.098*3cm) circle (2pt);
  \fill[orange!70] (270:0.583*3cm) circle (2pt);
  \fill[orange!70] (210:0.223*3cm) circle (2pt);
  \fill[orange!70] (150:0.273*3cm) circle (2pt);
\end{tikzpicture}
