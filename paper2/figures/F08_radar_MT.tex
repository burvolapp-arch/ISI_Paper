% F08: Radar chart for Malta (MT)
% Values: Fin=0.140, Ene=0.351, Tec=0.205, Def=1.000, Crit=0.409, Log=1.000
\begin{tikzpicture}[scale=1.0]
  ...
  \filldraw[blue!20, draw=blue!70, thick, fill opacity=0.3]
    ( 90:0.140*3cm) -- ( 30:0.351*3cm) -- (330:0.205*3cm) --
    (270:1.000*3cm) -- (210:0.409*3cm) -- (150:1.000*3cm) -- cycle;
  % Data points
  \fill[blue!70] ( 90:0.140*3cm) circle (2pt);
  \fill[blue!70] ( 30:0.351*3cm) circle (2pt);
  \fill[blue!70] (330:0.205*3cm) circle (2pt);
  \fill[blue!70] (270:1.000*3cm) circle (2pt);
  \fill[blue!70] (210:0.409*3cm) circle (2pt);
  \fill[blue!70] (150:1.000*3cm) circle (2pt);
\end{tikzpicture}
