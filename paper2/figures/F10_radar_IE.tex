% F10_radar_IE: Radar chart for Ireland (IE)
% Values: Fin=0.147, Ene=0.465, Tec=0.587, Def=0.449, Cri=0.307, Log=0.614
\begin{tikzpicture}[scale=1.0]
  ...
  % Data polygon: IE
  \filldraw[green!20, draw=green!70, thick, fill opacity=0.3]
    ( 90:0.147*3cm) -- ( 30:0.465*3cm) -- (330:0.587*3cm) --
    (270:0.449*3cm) -- (210:0.307*3cm) -- (150:0.614*3cm) -- cycle;
  % Data points
  \fill[green!70] ( 90:0.147*3cm) circle (2pt);
  \fill[green!70] ( 30:0.465*3cm) circle (2pt);
  \fill[green!70] (330:0.587*3cm) circle (2pt);
  \fill[green!70] (270:0.449*3cm) circle (2pt);
  \fill[green!70] (210:0.307*3cm) circle (2pt);
  \fill[green!70] (150:0.614*3cm) circle (2pt);
\end{tikzpicture}
