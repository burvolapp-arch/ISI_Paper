...
\begin{tcolorbox}[
  colback=blue!3, colframe=blue!60!black,
  title={\small\bfseries Methodological clarification: primary vs.\
    secondary instruments},
  fonttitle=\small, boxrule=0.5pt, arc=2pt,
  left=4pt, right=4pt, top=3pt, bottom=3pt
]
\small
The ISI's \textbf{primary analytical instrument} is the continuous
composite score (range $[0,1]$, four-decimal precision), supplemented
by the six axis-level scores and the structural typology.  The
four-tier classification (unconcentrated / mildly / moderately /
highly concentrated) is a \textbf{secondary communication device}
retained for policy briefs and non-specialist summaries.  The
compression diagnostics above demonstrate that the four-tier scheme
is inherently low-resolution: it explains only 48.3\% of
cross-country variance ($\eta^2 = 0.483$) and groups 85.2\% of
countries into a single tier spanning 0.207 on the unit interval.
Any analytical work requiring fine-grained country discrimination
--- including policy prioritisation, trend monitoring, and
cross-country benchmarking --- should use the continuous composite
and axis-level profiles, not the tier labels.
\end{tcolorbox}
