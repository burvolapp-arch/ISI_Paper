...
The composite mean (\num{0.3444}) slightly exceeds the median
(\num{0.3403}), indicating a mild positive skew driven by Malta's
outlying score of \num{0.5175}.  The coefficient of variation
...
(\num{0.2818}) occupies only 28.2\% of the theoretical $[0, 1]$
...
The Gini coefficient of \num{0.1155} indicates a relatively egalitarian
...
\num{0.2073} (from Spain at \num{0.2609} to Cyprus at
\num{0.4682}).  This wide within-tier range indicates that the
