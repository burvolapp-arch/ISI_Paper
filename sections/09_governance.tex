...
\begin{description}[style=nextline]
  \item[\texttt{major} increment.]
    ...
    formula, altering the classification thresholds, modifying the defence
    temporal window, rotating the signing key.  A major-version change resets
    the minor counter to~\(0\) and requires a new methodology document.
