...
the unit interval.  They are defined in the methodology registry and enforced
by a single classification function (\texttt{methodology.py}).  The thresholds
are fixed parameters of \ISI v\,1.0 and may only be revised through the
governance protocol specified in \cref{sec:governance}.